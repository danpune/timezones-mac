...
| <img src="docs/panel-dark.png" width="400" alt="The same panel in dark mode"> | **Make it yours.** 12h or 24h, °F or °C. **Nicknames and pins** lets you call a city "Mom" or "Office". The **⋯** menu shows which version you are on, and has Open at login, the ⌃⌥T shortcut, Copy a link to the website, and Quit. |
